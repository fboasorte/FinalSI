...
<body>
    <div id='box_cadastro' style='margin-top: 4%;'>
        <h1 class="form_titulo">Atualização</h1>
        <p>
        ...
        <div class="campo_cadastro">
            <input type="text" id="nome" name="nome" class="form_input" placeholder="Digite o produto..." required="required" />
        </div>
        <div class="campo_cadastro">
            <input type="email" name="email" class="form_input" placeholder="Digite a quantidade..." required="required"/>
        </div>
