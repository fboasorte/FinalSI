...
<body>
    <div id='box_cadastro' style='margin-top: 4%;'>
        <h1 class="form_titulo"> Excluir</h1>
        <div class="campo_cadastro">
            <input type="text" id="cpf" name="cpf" class="form_input" placeholder="Digite o codigo..." required="required" />
            <br>
        </div>
        <div style="margin: 20px; width: 500px; height:200px; border: 3px solid #CCC;">
            Tabela
        </div>
        <div class="campo_cadastro" id="teste">
            <input type="submit" onclick="return Cadastrar()" class="form_button" value="Apagar"/>
        </div>
    </div>    
    <footer>
        <p>
